...
exports.signup = (app) => {
  return async function signup(req, res, next) {
    ...
    // const pers = `animal_cat:find,animal_cat:get,animals:find,animals:get,notes:find,notes:get,notes:create,notification:find,notifications:get,sensor-data:find,sensor-data:get`
